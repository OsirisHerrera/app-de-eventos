...
<div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-black border border-gray-900 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        <a data-tooltip-target="tooltip-home" onclick="window.location.href='index.html'" type="button" class="inline-flex flex-col items-center justify-center px-5 rounded-l-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
        ...
        <button data-tooltip-target="tooltip-wallet" onclick="window.location.href='informacion.html'" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
